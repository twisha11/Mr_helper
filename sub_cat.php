...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-lg-8 d-none d-md-block">
                            <nav class="mainmenu__nav  d-none d-lg-block">
                                <ul class="main__menu">
                                    <li class="drop" ><a href="admin.php">Home</a>
                                    </li>
                                    <li><a href="sub_cat.php">sub-catagory</a></li>
    ...
    <section>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form action="sub_cat_process.php" method="post" enctype="multipart/form-data">
                ...
                <?php
                 ...
                 {
                    echo "<b text-color:'green'>*~*ADD CATEGORY SUCESSFULLY*~*</b>";   
                    unset($_SESSION['done']);           
                 } 
                ...
                else if (!empty($_SESSION['error']))
                  {
                    ...
                    {
                       echo '<b><font color="red">'.$er.'</font></b>';
                    }
                ...
                <select name="cat" class="form-control" style="height: 35px;">
                        ...
                        {
                            echo '<option value="'.$catrow['id'].'">'.$catrow['cat_name'].'</option>';
                        }
                ...
                <label>image of subcategory</label>
