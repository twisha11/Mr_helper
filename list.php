                        ...
                        <div class="col-md-12" >
                            <div class="search__inner">
                                <form action="search.php" method="post">
                                    <input placeholder="Search here... " type="text" name="search1">
                                    <button type="submit" name="searchsub"></button>
                                </form>
...
<!-- Start Bradcaump area -->
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url('images/bg.jfif') no-repeat scroll center center / cover ;">
            <div class="ht__bradcaump__wrap">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title"><?php echo $_GET['cat'] ?></h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="index.php">mr.helper</a>
                                </nav>
                            </div>
                        </div>
                    </div>
...
$uid=$_GET['uid'];
 $id=$_GET['id'];
   $lq = "select * from empdetail where e_cat=$id";
   $lr = mysqli_query($con,$lq);
   ...
   while ($lrow = mysqli_fetch_assoc($lr))
   {
    ...
    <div class="container">
      <div class="row" >
         ...
         <div class="col-md-4 ">
           <img src="pic/'.$lrow['image'].'" class="service-img" style="width:250px; height:240px; border-radius:50%;">
         </div>
         <div class="col-md-8 pull-right">
           <h2>'.$lrow['e_name'].'</h2><br>
            <p class="bn">'.$lrow['e_desc'].'</p>
           
            <div class="gh">
            <a href="product-details.php?id='.$lrow['e_id'].'&uid='.$uid.'"><button class="btn btn-primary">more..</button></a>
            </div>
        </div>
      </div>
     </div>
